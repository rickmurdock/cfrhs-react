...
import Caboose from '../images/Caboose.jpg';
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-10">
        ...
        <img src={Caboose} alt="" className="img-flid img-caboose col-sm-7 col-xs-7 pull-right"/>
        <p>
        ...
        <img src={Plaque} alt="bronze museum plaque" className="img-fluid img-plaque col-sm-6 col-xs-6 col-xl-5 pull-left"/>
        <p>
